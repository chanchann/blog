...
#### **10.1.1 Configure `proxy` in `package.json`**
...
#### **10.1.2 Direct API Requests (Requires Backend CORS Support)**
...
#### **10.2.1 Standard Library net/http + rs/cors**
